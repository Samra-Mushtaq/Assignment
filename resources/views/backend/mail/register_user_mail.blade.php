...
<head>
    ...
    <title>Register User Mail</title>
                            ...
                            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        <h1 style="color:#1e1e2d; font-weight:500; margin:0;font-size:32px;font-family:'Rubik',sans-serif;">New User Registration
                                        </h1>
                                        <p style="font-size:15px; color:#455056; margin:8px 0 0; line-height:24px;">
                                            New User has been registered. Information related to user is given below, <br><strong>Please assign 
                                            suitable roles to the new user</strong>.</p>
                                        <span
