...
<html lang="en">
  ...
  <body>
    ...
    {{-- javascript code --}}
   <script src="https://maps.google.com/maps/api/js?key=AIzaSyALejp4FPESxkyrrSx4vxOImAiTgAzl_Xg&libraries=places&callback=initAutocomplete" type="text/javascript"></script>
